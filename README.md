...
این پروژه یک فرایند ساده‌ی تبدیل و بازسازی متن را پیاده‌سازی می‌کند که شامل:
- کدگذاری متن
- پردازش داده
- نگاشت به نمایش متنی فارسی
...
- هیچ ادعای امنیتی یا رمزنگاری ندارد و برای داده‌های حساس طراحی نشده
