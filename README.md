...
- 📝 **چهار حالت نمایش** - فشرده، طبیعی‌تر، کلمه‌ای و رمزدار
...
| طبیعی‌تر | نگاشت با فاصله‌گذاری | یادگیری text normalization |
| کلمه‌ای | نگاشت به ۲۵۶ کلمه فارسی | یادگیری byte-to-word mapping |
